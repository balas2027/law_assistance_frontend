    ...
    <div className="w-full lg:w-80 flex-shrink-0 space-y-6">
      <div className="bg-surface-container-lowest rounded-xl border border-ink-border shadow-level-1 p-6">
        ...
        <div className="space-y-6">
          <div>
            <label className="block font-label-caps text-label-caps text-on-surface-variant mb-2">Topic</label>
            <select
          ...
          <div>
            <label className="block font-label-caps text-label-caps text-on-surface-variant mb-2">Max Lives</label>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-error/10 flex items-center justify-center border border-error/30">
                <Icon name="favorite" size={20} fill className="text-error" />
              </div>
              <input
                className="w-24 bg-surface-container-lowest border border-ink-border rounded-lg px-3 py-2 font-citation text-citation text-primary text-center focus:outline-none focus:border-saffron transition-colors"
                type="number"
              ...
              />
              <span className="font-body-md text-body-md text-on-surface-variant">Lives</span>
            </div>
          </div>
